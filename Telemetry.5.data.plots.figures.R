...
load("Telemetry.spatial.predictions.protected.areas.RData")
...
cowplot::save_plot("Plots/Finalized/covar.plot.png",
                   plot = covar.plot, 
                   base_width = 8,
                   base_height = 6.5)

cowplot::save_plot("Plots/Finalized/coef.plot.png",
                   plot = coef.plot, 
                   base_width = 8,
                   base_height = 6.5)

cowplot::save_plot("Plots/Finalized/spatialmap.png",
                   plot = spatialmap, 
                   base_width = 12.5,
                   base_height = 8)

cowplot::save_plot("Plots/Finalized/mpa.temp.plots.png",
                   plot = mpa.temp.plots, 
                   base_width = 8,
                   base_height = 6.5)
