...
load("Telemetry.clean.calculate.mpm.RData")
...
Bathymetry <- raster("Bathymetry/gebco_2021_n47.85417_s36.15417_w45.90417_e54.875.tif")
...
extract.ice.data <- function(data){
  ...
  ice.data <- stack(list.files("asi.ice.telemetry.work/", full.names = T))
...
#####
#if on ice sometimes the movement of the ice/ amount ice gives ARS, 
...
#save.image("Telemetry.create.extract.enviro.data.RData")
