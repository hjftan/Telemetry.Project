...
load("Telemetry.create.extract.enviro.data.RData")
...
#because foraging activity near these features may be driven by prey presence
#and the fish prey of Caspian seals may exhibit spatially and temporally structured
#lifecycles
...
#save.image("Telemetry.fit.inla.model.RData")
