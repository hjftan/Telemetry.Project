...
list.files("F:/Project.Caspian.Hardrive/Misc.Data/HARRI_telem_data/Tag_Seals_details/csv.splits", 
           pattern = ".Individual.Details.csv",
           full.names = T)

Indiviudal.Details.2016 <- read.csv(list.files("F:/Project.Caspian.Hardrive/Misc.Data/HARRI_telem_data/Tag_Seals_details/csv.splits", 
                                               pattern = ".Individual.Details.csv",
...
Indiviudal.Details.2017 <- read.csv(list.files("F:/Project.Caspian.Hardrive/Misc.Data/HARRI_telem_data/Tag_Seals_details/csv.splits", 
                                               pattern = ".Individual.Details.csv",
...
Indiviudal.Details.2008.12 <- read.csv(list.files("F:/Project.Caspian.Hardrive/Misc.Data/HARRI_telem_data/Tag_Seals_details/csv.splits", 
                                                  pattern = ".Individual.Details.csv",
...
list.files("F:/Project.Caspian.Hardrive/Misc.Data/HARRI_telem_data/Filtered_raw_data",
           pattern = ".csv", full.names = T)

Filtered.Raw.SSM.2008 <- read.csv(list.files("F:/Project.Caspian.Hardrive/Misc.Data/HARRI_telem_data/Filtered_raw_data",
                                             pattern = ".csv", full.names = T)[1], stringsAsFactors = FALSE)
Filtered.Raw.SSM.2009 <- read.csv(list.files("F:/Project.Caspian.Hardrive/Misc.Data/HARRI_telem_data/Filtered_raw_data",
                                             pattern = ".csv", full.names = T)[2], stringsAsFactors = FALSE)
Filtered.Raw.SSM.2010 <- read.csv(list.files("F:/Project.Caspian.Hardrive/Misc.Data/HARRI_telem_data/Filtered_raw_data",
                                             pattern = ".csv", full.names = T)[3], stringsAsFactors = FALSE)
Filtered.Raw.SSM.2011 <- read.csv(list.files("F:/Project.Caspian.Hardrive/Misc.Data/HARRI_telem_data/Filtered_raw_data",
                                             pattern = ".csv", full.names = T)[4], stringsAsFactors = FALSE)
Filtered.Raw.SSM.2012 <- read.csv(list.files("F:/Project.Caspian.Hardrive/Misc.Data/HARRI_telem_data/Filtered_raw_data",
                                             pattern = ".csv", full.names = T)[5], stringsAsFactors = FALSE)
Filtered.Raw.SSM.2016.1 <- read.csv(list.files("F:/Project.Caspian.Hardrive/Misc.Data/HARRI_telem_data/Filtered_raw_data",
                                               pattern = ".csv", full.names = T)[6], stringsAsFactors = FALSE)
Filtered.Raw.SSM.2016.2 <- read.csv(list.files("F:/Project.Caspian.Hardrive/Misc.Data/HARRI_telem_data/Filtered_raw_data",
                                               pattern = ".csv", full.names = T)[7], stringsAsFactors = FALSE)
Filtered.Raw.SSM.2017 <- read.csv(list.files("F:/Project.Caspian.Hardrive/Misc.Data/HARRI_telem_data/Filtered_raw_data",
...
####################################################################################################
#join function is broken, see how plots for some ids dont match the fmap output an dgenerally look wrong
#below needs to be tidied up, but jsut joins data with fitted values
...
#save.image("F:/Project.Caspian.Hardrive/RScripts/Telemetry.Work/Telemetry.clean.calculate.mpm.RData")
